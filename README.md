...
Public, evidence-backed thematic research published at <https://rsalek.github.io/research/>.
...
Each report is a standalone HTML file linked from `index.html`. Its library card should include:
